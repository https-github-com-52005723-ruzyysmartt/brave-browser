  ...
  runCoverage: (options = config.defaultOptions) => {
    ...
    // is_component_build=false - is recommended from Chromium, but may not be required (works without it)
      ...
      util.run('python', [ 
        ...
        "-b", "out/brave/coverage", // build path from COVERAGE_OUT_DIR arg
        "-o", "out/brave/report", // build path from COVERAGE_OUT_DIR arg
        "-c", "out/brave/coverage/brave_unit_tests", // build path from COVERAGE_OUT_DIR arg 
